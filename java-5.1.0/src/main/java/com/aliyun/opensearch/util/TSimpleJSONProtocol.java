...
public class TSimpleJSONProtocol extends TProtocol {
  ...
  protected class Context {
    ...
    /**
     * @return Returns whether the current value is a key in a map
     */
   ...
   *
   * @param invalidKeyType   invalidKeyType
   * @throws CollectionMapKeyException  CollectionMapKeyException
   */
