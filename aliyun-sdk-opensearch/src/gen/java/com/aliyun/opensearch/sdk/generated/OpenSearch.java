...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.20.0)", date = "2024-05-24")
public class OpenSearch implements org.apache.thrift.TBase<OpenSearch, OpenSearch._Fields>, java.io.Serializable, Cloneable, Comparable<OpenSearch> {
  ...
  private static final org.apache.thrift.protocol.TField BEARER_TOKEN_FIELD_DESC = new org.apache.thrift.protocol.TField("bearerToken", org.apache.thrift.protocol.TType.STRING, (short)10);
  ...
  public java.lang.String bearerToken; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BEARER_TOKEN((short)10, "bearerToken");
  ...
  private static final _Fields optionals[] = {_Fields.OPTIONS,_Fields.GZIP,_Fields.TIMEOUT,_Fields.CONNECT_TIMEOUT,_Fields.EXPIRED,_Fields.SECURITY_TOKEN,_Fields.BEARER_TOKEN};
  ...
  static {
    ...
    tmpMap.put(_Fields.SECURITY_TOKEN, new org.apache.thrift.meta_data.FieldMetaData("securityToken", org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.BEARER_TOKEN, new org.apache.thrift.meta_data.FieldMetaData("bearerToken", org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public OpenSearch setBearerToken(java.lang.String bearerToken) {
  ...
  /** Returns true if field bearerToken is set (has been assigned a value) and false otherwise */
  public boolean isSetBearerToken() {
    return this.bearerToken != null;
  }

  public void setBearerTokenIsSet(boolean value) {
    if (!value) {
      this.bearerToken = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case BEARER_TOKEN:
      if (value == null) {
        ...
        setBearerToken((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(OpenSearch that) {
    ...
    boolean this_present_bearerToken = true && this.isSetBearerToken();
    boolean that_present_bearerToken = true && that.isSetBearerToken();
    if (this_present_bearerToken || that_present_bearerToken) {
      if (!(this_present_bearerToken && that_present_bearerToken))
        return false;
      if (!this.bearerToken.equals(that.bearerToken))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetBearerToken()) ? 131071 : 524287);
    if (isSetBearerToken())
      hashCode = hashCode * 8191 + bearerToken.hashCode();
  ...
  public int compareTo(OpenSearch other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBearerToken()).compareTo(other.isSetBearerToken());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBearerToken()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bearerToken, other.bearerToken);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class OpenSearchStandardScheme extends org.apache.thrift.scheme.StandardScheme<OpenSearch> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, OpenSearch struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 10: // BEARER_TOKEN
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.bearerToken = iprot.readString();
              struct.setBearerTokenIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OpenSearch struct) throws org.apache.thrift.TException {
      ...
      if (struct.bearerToken != null) {
        if (struct.isSetBearerToken()) {
          oprot.writeFieldBegin(BEARER_TOKEN_FIELD_DESC);
          oprot.writeString(struct.bearerToken);
          oprot.writeFieldEnd();
        }
      }
