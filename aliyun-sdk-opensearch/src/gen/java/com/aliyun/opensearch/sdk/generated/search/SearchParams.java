...
public class SearchParams implements org.apache.thrift.TBase<SearchParams, SearchParams._Fields>, java.io.Serializable, Cloneable, Comparable<SearchParams> {
  ...
  private Config config; // required
  private String query; // optional
  private String filter; // optional
  private Sort sort; // optional
  private Rank rank; // optional
  private Set<Aggregate> aggregates; // optional
  private Set<Distinct> distincts; // optional
  private Set<Summary> summaries; // optional
  private List<String> queryProcessorNames; // optional
  private DeepPaging deepPaging; // optional
  private Map<String,String> disableFunctions; // optional
  private Map<String,String> customParam; // optional
  private Suggest suggest; // optional
  private Abtest abtest; // optional
  ...
  private static final _Fields optionals[] = {_Fields.QUERY,_Fields.FILTER,_Fields.SORT,_Fields.RANK,_Fields.AGGREGATES,_Fields.DISTINCTS,_Fields.SUMMARIES,_Fields.QUERY_PROCESSOR_NAMES,_Fields.DEEP_PAGING,_Fields.DISABLE_FUNCTIONS,_Fields.CUSTOM_PARAM,_Fields.SUGGEST,_Fields.ABTEST,_Fields.USER_ID,_Fields.RAW_QUERY};
   ...
   * value 待禁用函数的详细说明
   *
   * @param disableFunctions disableFunctions
   * @return SearchParams
   */
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.aggregates = new HashSet<Aggregate>(2*_set32.size);
                Aggregate _elem33;
                for (int _i34 = 0; _i34 < _set32.size; ++_i34)
                {
                  _elem33 = new Aggregate();
                  _elem33.read(iprot);
                  struct.aggregates.add(_elem33);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.distincts = new HashSet<Distinct>(2*_set35.size);
                Distinct _elem36;
                for (int _i37 = 0; _i37 < _set35.size; ++_i37)
                {
                  _elem36 = new Distinct();
                  _elem36.read(iprot);
                  struct.distincts.add(_elem36);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.summaries = new HashSet<Summary>(2*_set38.size);
                Summary _elem39;
                for (int _i40 = 0; _i40 < _set38.size; ++_i40)
                {
                  _elem39 = new Summary();
                  _elem39.read(iprot);
                  struct.summaries.add(_elem39);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.queryProcessorNames = new ArrayList<String>(_list41.size);
                String _elem42;
                for (int _i43 = 0; _i43 < _list41.size; ++_i43)
                {
                  _elem42 = iprot.readString();
                  struct.queryProcessorNames.add(_elem42);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.disableFunctions = new HashMap<String,String>(2*_map44.size);
                String _key45;
                String _val46;
                for (int _i47 = 0; _i47 < _map44.size; ++_i47)
                {
                  ...
                  struct.disableFunctions.put(_key45, _val46);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.customParam = new HashMap<String,String>(2*_map48.size);
                String _key49;
                String _val50;
                for (int _i51 = 0; _i51 < _map48.size; ++_i51)
                {
                  ...
                  struct.customParam.put(_key49, _val50);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.aggregates != null) {
        if (struct.isSetAggregates()) {
          oprot.writeFieldBegin(AGGREGATES_FIELD_DESC);
          {
            ...
            for (Aggregate _iter52 : struct.aggregates)
            {
              _iter52.write(oprot);
            }
            oprot.writeSetEnd();
      ...
      if (struct.distincts != null) {
        if (struct.isSetDistincts()) {
          oprot.writeFieldBegin(DISTINCTS_FIELD_DESC);
          {
            ...
            for (Distinct _iter53 : struct.distincts)
            {
              _iter53.write(oprot);
            }
            oprot.writeSetEnd();
      ...
      if (struct.summaries != null) {
        if (struct.isSetSummaries()) {
          oprot.writeFieldBegin(SUMMARIES_FIELD_DESC);
          {
            ...
            for (Summary _iter54 : struct.summaries)
            {
              _iter54.write(oprot);
            }
            oprot.writeSetEnd();
      ...
      if (struct.queryProcessorNames != null) {
        if (struct.isSetQueryProcessorNames()) {
          oprot.writeFieldBegin(QUERY_PROCESSOR_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter55 : struct.queryProcessorNames)
            {
      ...
      if (struct.disableFunctions != null) {
        if (struct.isSetDisableFunctions()) {
          oprot.writeFieldBegin(DISABLE_FUNCTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter56 : struct.disableFunctions.entrySet())
            {
      ...
      if (struct.customParam != null) {
        if (struct.isSetCustomParam()) {
          oprot.writeFieldBegin(CUSTOM_PARAM_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter57 : struct.customParam.entrySet())
            {
  ...
  private static class SearchParamsTupleScheme extends TupleScheme<SearchParams> {
      ...
      if (struct.isSetAggregates()) {
        {
          ...
          for (Aggregate _iter58 : struct.aggregates)
          {
            _iter58.write(oprot);
          }
        }
      ...
      if (struct.isSetDistincts()) {
        {
          ...
          for (Distinct _iter59 : struct.distincts)
          {
            _iter59.write(oprot);
          }
        }
      ...
      if (struct.isSetSummaries()) {
        {
          ...
          for (Summary _iter60 : struct.summaries)
          {
            _iter60.write(oprot);
          }
        }
      ...
      if (struct.isSetQueryProcessorNames()) {
        {
          ...
          for (String _iter61 : struct.queryProcessorNames)
          {
      ...
      if (struct.isSetDisableFunctions()) {
        {
          ...
          for (Map.Entry<String, String> _iter62 : struct.disableFunctions.entrySet())
          {
      ...
      if (struct.isSetCustomParam()) {
        {
          ...
          for (Map.Entry<String, String> _iter63 : struct.customParam.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SearchParams struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TSet _set64 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.aggregates = new HashSet<Aggregate>(2*_set64.size);
          Aggregate _elem65;
          for (int _i66 = 0; _i66 < _set64.size; ++_i66)
          {
            _elem65 = new Aggregate();
            _elem65.read(iprot);
            struct.aggregates.add(_elem65);
          }
        }
        struct.setAggregatesIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.distincts = new HashSet<Distinct>(2*_set67.size);
          Distinct _elem68;
          for (int _i69 = 0; _i69 < _set67.size; ++_i69)
          {
            _elem68 = new Distinct();
            _elem68.read(iprot);
            struct.distincts.add(_elem68);
          }
        }
        struct.setDistinctsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.summaries = new HashSet<Summary>(2*_set70.size);
          Summary _elem71;
          for (int _i72 = 0; _i72 < _set70.size; ++_i72)
          {
            _elem71 = new Summary();
            _elem71.read(iprot);
            struct.summaries.add(_elem71);
          }
        }
        struct.setSummariesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.queryProcessorNames = new ArrayList<String>(_list73.size);
          String _elem74;
          for (int _i75 = 0; _i75 < _list73.size; ++_i75)
          {
            _elem74 = iprot.readString();
            struct.queryProcessorNames.add(_elem74);
          }
        }
        struct.setQueryProcessorNamesIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.disableFunctions = new HashMap<String,String>(2*_map76.size);
          String _key77;
          String _val78;
          for (int _i79 = 0; _i79 < _map76.size; ++_i79)
          {
            ...
            struct.disableFunctions.put(_key77, _val78);
          }
        }
        struct.setDisableFunctionsIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.customParam = new HashMap<String,String>(2*_map80.size);
          String _key81;
          String _val82;
          for (int _i83 = 0; _i83 < _map80.size; ++_i83)
          {
            ...
            struct.customParam.put(_key81, _val82);
          }
        }
        struct.setCustomParamIsSet(true);
      }
